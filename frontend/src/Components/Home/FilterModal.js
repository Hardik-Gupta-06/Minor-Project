...
import PropTypes from "prop-types"; // type checking props
...
const FilterModal = ( {selectedFilters , onFilterChange , onclose} ) => {
    ...
    const handleFilterChange = () => {
        ...
        onFilterChange("rommType" , roomType)
      ...
      <div className="modal-content">
        ...
        <div className="modal-filters-container">
          ...
          <div className='filter-buttons'>
                <button className='clear-button bg-primary' onClick={handleClearFilters}> Clear </button>
                <button className='clear-button bg-success' onClick={handleFilterChange}> Apply Filters </button>
          </div>
        </div>
      </div>
    </div>
