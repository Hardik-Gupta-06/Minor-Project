...
import AccomodationForm from './Components/Accommodation/AccomodationForm';
import Accomodation from './Components/Accommodation/Accomodation';

function App() {

  const stripePromise = loadStripe( "pk_live_51OtTZASFYR9OacQDuZPypFZuwjXpAsShpQQmL1KawHcpw625ZhUVj9FDVGaKQVcWmpHpjBjriLho59yuqk2wENjC00p5DtbMl0"
  )
  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path='/' element={ <Main /> } id="main" exact >  
        ...
        <Route id='accommodation' path='accommodation' element={ <Accomodation /> } />
        <Route id='accommodationform' path='accommodationform' element={ <AccomodationForm /> } />
      </Route>
    )
  )
  return (
